...
/**
 * A tela de cadastro de fornecedores que permite ao usuário inserir as informações
 * de um fornecedor, como nome, CNPJ, telefone e e-mail, e enviar esses dados 
 * para um banco de dados para o cadastro.
 * 
 * Esta classe estende JInternalFrame e oferece uma interface gráfica com campos
 * para o usuário preencher os dados do fornecedor e botões para enviar ou sair.
 * 
 * @author Breno de Souza
 */
public class TelaCadastroFornecedor extends JInternalFrame {
    /**
     * Constrói uma nova instância de TelaCadastroFornecedor.
    ...
    * Este código é gerado automaticamente pelo Form Editor e não deve ser modificado manualmente.
    */
    ...
    * Fecha a janela da tela de cadastro de fornecedores.
    * 
    * @param evt Evento gerado ao clicar no botão de sair.
    */
